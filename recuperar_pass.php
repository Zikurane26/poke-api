...
$mail = new PHPMailer(true);
  ...
  if(isset($_POST['btn_send']))
  {
   ...
   try
   {
    ...
    $mail->Username   ="Brasti00@gmail.com";  
                         $mail->Password   ="your_gmail_password ._.";            
                         $mail->SetFrom('Brasti00@gmail.com','Programacion net');
                         $mail->AddReplyTo("Brasti00@gmail.com","Programacion net");
