    ...
    <aside id="menu" class="hidden_lateral_menu hidden_all">
        ...
        <ul>
            ...
            <li>
                <div class="container-menu">
                    ...
                    <a id="submenu_alpha" class="text" href="/backend/dashboard.php">Dashboard</a>
                </div>
                <hr class="hr">
                <!-- Sub menu A -->
            ...
            <li>
                <div class="container-menu">
                    <div class="logo-home"></div>
                    <a href="user" class="text">Usuarios</a>
                </div>
                <hr class="hr">
            </li>
            <li>
